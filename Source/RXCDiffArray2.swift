...
public final class RXCDiffArray2<ElementContainer: RangeReplaceableCollection>: Collection {

    public typealias Element = ElementContainer.Element
    public typealias Index = ElementContainer.Index
    public typealias Difference = RDADifference2<ElementContainer>
...
//MARK: - Section
extension RXCDiffArray2 where Index==Int {
...
//MARK: - Element
extension RXCDiffArray2 where Element: RDASectionElementProtocol, Index==Int {
